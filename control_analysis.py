...
def crop_by_start_and_end(custom_raw):
    ...
    cropped_raw = custom_raw.crop(52782, 52812) # testing dataset - 52800, 52805 for seizure, 52910, 52915 for non seizure
    return cropped_raw
...
def main():
    ...
    read_yaml_config.calculate_recording_duration(configuration_path)
